...
//        NhanVien.setSelectedIndex(0);
    ...
    void update() {
      ...
      boolean isValidated(){
        ...
        if(txtMaPK.getText().trim().length() == 0){
            // 1.thông báo lỗi 
            JOptionPane.showMessageDialog(this, " Mã Phiếu Khám không được để trống !");
            // 2. set màu
            txtMaPK.setBackground(Color.YELLOW);
            // 3. sét nháy
            txtMaPK.requestFocus();
        ...
        if(JDCNgayKham.getDate() == null){
            // 1.thông báo lỗi 
            JOptionPane.showMessageDialog(this, "Ngày Khám không được để trống !");
            return false;
        }
        ...
        // ********************************************************************** // 
           ...
           // kiểm tra giờ Khám
        if(txtGioKham.getText().trim().length() == 0){
            // 1.thông báo lỗi 
            JOptionPane.showMessageDialog(this, " Giờ Khám không được để trống !");
            // 2. set màu
            txtGioKham.setBackground(Color.YELLOW);
            // 3. sét nháy
            txtGioKham.requestFocus();
            // 4. kết thúc hàm ko làm các lệnh phía sau
            return false; 
        }else{
            txtGioKham.setBackground(Color.white);
        }
        ...
        if(txtMaNV.getText().trim().length() == 0){
            // 1.thông báo lỗi 
            JOptionPane.showMessageDialog(this, "MaNV không được để trống !");
            // 2. set màu
        ...
        if(txtDauHieuBenh.getText().trim().length() == 0){
            // 1.thông báo lỗi 
            JOptionPane.showMessageDialog(this, " Dấu Hiệu Bệnh     không được để trống !");
            // 2. set màu
